...
bool World::hasAlivePlayer() const { return mPlayerAircrafts.size() > 0; }
...
void World::loadTextures() {
    ...
    mTextures.load(Textures::Jungle, "./gfx/textures/Jungle.png");
    mTextures.load(Textures::Explosion, "./gfx/textures/Explosion.png");
    mTextures.load(Textures::Particle, "./gfx/textures/Particle.png");
    mTextures.load(Textures::FinishLine, "./gfx/textures/FinishLine.png");
}
...
void World::updateSounds() {
    ...
    mSounds.setListenerPosition(listenerPosition);      // Set listener's position    
