...
, mSecondPassTextures()
{
	mShaders.load(Shaders::BrightnessPass,   "./gfx/shaders/Fullpass.vert", "./gfx/shaders/Brightness.frag");
	mShaders.load(Shaders::DownSamplePass,   "./gfx/shaders/Fullpass.vert", "./gfx/shaders/DownSample.frag");
	mShaders.load(Shaders::GaussianBlurPass, "./gfx/shaders/Fullpass.vert", "./gfx/shaders/GuassianBlur.frag");
	mShaders.load(Shaders::AddPass,          "./gfx/shaders/Fullpass.vert", "./gfx/shaders/Add.frag");
}
